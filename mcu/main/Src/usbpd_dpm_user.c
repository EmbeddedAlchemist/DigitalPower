...
/* USER CODE BEGIN USBPD_DPM_UserCableDetection */
    impl_USBPD_DPM_UserCableDetection(PortNum, State);
...
/* USER CODE BEGIN USBPD_DPM_Notification */
    impl_USBPD_DPM_Notification(PortNum, EventVal);
...
/* USER CODE BEGIN USBPD_DPM_GetDataInfo */
    impl_USBPD_DPM_GetDataInfo(PortNum, DataId, Ptr, Size);
...
impl_USBPD_DPM_SetDataInfo(PortNum, DataId, Ptr, Size);
...
/* USER CODE BEGIN USBPD_DPM_SNK_EvaluateCapabilities */
    impl_USBPD_DPM_SNK_EvaluateCapabilities(PortNum, PtrRequestData, PtrPowerObjectType);
